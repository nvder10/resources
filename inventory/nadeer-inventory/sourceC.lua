...
function displayItems()
	...
	dxDrawImage(1269, 348, 325, 440, ":nadeer_inventory/inventory.png")
	dxDrawText("$"..exports.global:formatMoney(getElementData(localPlayer,"money")), 1312,371,1413,387,tocolor(255,255,255,255),1,dxfont0 or "default","left","top")
	dxDrawText("$"..exports.global:formatMoney(getElementData(localPlayer,"bankmoney")), 1312,391,1413,407,tocolor(255,255,255,255),1,dxfont0 or "default","left","top")
