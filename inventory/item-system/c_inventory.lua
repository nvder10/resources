...
function getHoverElement( force )
...
local dxfont0 = dxCreateFont(":nadeer_jobclick/Tajawal-Bold.ttf", 10)

local tooltipYet = false
function tooltip( x, y, text, text2, action, item )
	tooltipYet = true
	...
	dxDrawRectangleBorde( x, y, width, height, tooltip_background_color[action or 'default'], true )
	dxDrawText( text, x, y, x + width, y + height, tooltip_text_color, 1, dxfont0 or "arial", "center", "center", false, false, true )
end
...
function getOverlayText( itemID, itemValue, metadata, isGrouped )
